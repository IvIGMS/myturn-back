...
class JobScheduledTest {
  ...
  @InjectMocks private JobScheduled jobScheduled;
  ...
  class SendNotificationsTests {
    ...
    void sendNotifications_whenUnsentNotificationsExist_shouldSendThem() {
      ...
      List<NotificationEntity> notifications =
          List.of(new NotificationEntity(), new NotificationEntity());
      when(notificationService.getNotificationsNotSendedByType(
      ...
      verify(notificationService)
          .getNotificationsNotSendedByType(NotificationTypeEnum.END_SUBSCRIPTION);
