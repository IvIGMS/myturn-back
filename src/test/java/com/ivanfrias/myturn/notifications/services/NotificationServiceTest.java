...
class NotificationServiceTest {
    ...
    class GetNotificationsNotSendedByTypeTests {
        ...
        void getNotificationsNotSendedByType_shouldCallRepository() {
            // Arrange
            when(notificationRepository.findByNotificationTypeAndIsSendedFalse(NotificationTypeEnum.END_SUBSCRIPTION))
                    .thenReturn(Collections.singletonList(notificationEntity));

            // Act
            List<NotificationEntity> result = notificationService.getNotificationsNotSendedByType(NotificationTypeEnum.END_SUBSCRIPTION);

            // Assert
            verify(notificationRepository).findByNotificationTypeAndIsSendedFalse(NotificationTypeEnum.END_SUBSCRIPTION);
            assertNotNull(result);
