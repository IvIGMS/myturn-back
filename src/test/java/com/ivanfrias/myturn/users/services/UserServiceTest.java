...
class UserServiceTest {
    ...
    class GetAdminUsersTests {
        ...
        void getAdminUsers_whenAdminsExist_thenReturnUserEntityList() {
            ...
            when(userRepository.findByRole(RoleEnum.ADMIN)).thenReturn(Collections.singletonList(userEntity));
    ...
    class UsersDownTodayTests {
        ...
        void usersDownToday_whenUsersDownExist_thenReturnUserDownDtoList() {
            UserDownDto userDownDto = new UserDownDto() {
                public String getNombre() { return "Test"; }
                public String getApellidos() { return "User"; }
            };
            when(userRepository.usersDownToday(any(LocalDate.class))).thenReturn(Collections.singletonList(userDownDto));
