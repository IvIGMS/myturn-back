...
class UserControllerTest extends AbstractControllerTest {
  ...
  void testGetSelfUser() {
    ...
    var userDto = UserDTO.builder().id(1L).firstname("Ronaldo").lastname("Nazario").build();
  ...
  void testLinkUserToCompany_ko() {
    ...
    assertThrows(UnauthorizedException.class, () -> userController.linkUserToCompany("dNdb24ksd"));
  }
