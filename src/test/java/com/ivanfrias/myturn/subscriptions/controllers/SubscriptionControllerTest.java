...
class SubscriptionControllerTest extends AbstractControllerTest {
    ...
    class CreateSubscriptionTests {
        ...
        void createSubscription_asAdmin_shouldCreateSubscription() {
            ...
            when(subscriptionService.createSubscription(anyLong(), any(LocalDate.class), anyInt(), anyLong())).thenReturn(subscriptionDTO);

            ResponseEntity<SubscriptionDTO> response = subscriptionController.createSubscription(requestDTO);
        ...
        void createSubscription_asNonAdmin_shouldThrowUnauthorizedException() {
            ...
            assertThrows(UnauthorizedException.class, () -> subscriptionController.createSubscription(requestDTO));
        }
    }
    ...
    class GetSubscriptionsByUserIdTests {
        ...
        void getSubscriptionsByUserId_asAdmin_shouldReturnSubscriptions() {
            ...
            when(subscriptionService.getSubscriptionsByUserId(2L, 1L)).thenReturn(Collections.singletonList(subscriptionDTO));

            ResponseEntity<List<SubscriptionDTO>> response = subscriptionController.getSubscriptionsByUserId(2L);
        ...
        void getSubscriptionsByUserId_asNonAdmin_shouldThrowUnauthorizedException() {
            ...
            assertThrows(UnauthorizedException.class, () -> subscriptionController.getSubscriptionsByUserId(2L));
        }
    }
